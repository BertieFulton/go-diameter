...
const (
	...
	TGPPAllocateIPType                         = 27
	TGPPCAMELChargingInfo                      = 24
	TGPPCGAddress                              = 4
	TGPPCGIPv6Address                          = 14
	TGPPChargingCharacteristics                = 13
	TGPPChargingID                             = 2
	TGPPGGSNAddress                            = 7
	TGPPGGSNIPv6Address                        = 16
	TGPPGGSNMCCMNC                             = 9
	TGPPGPRSNegotiatedQoSProfile               = 5
	TGPPIMEISV                                 = 20
	TGPPIMSI                                   = 1
	TGPPIMSIMCCMNC                             = 8
	TGPPIPv6DNSServers                         = 17
	TGPPMSTimeZone                             = 23
	TGPPNSAPI                                  = 10
